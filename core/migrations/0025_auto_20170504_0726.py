    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='withdraw_tickets', to='core.WechatUser', verbose_name='提现用户')),
            ],
            options={
                'verbose_name': '提现票据',
